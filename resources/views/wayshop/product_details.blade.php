            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-item {{$key==0 ? 'active' : ''}}"> <img class="d-block w-100" src="{{asset('storage/products/'.$images->image)}}" alt="First slide"> </div>
                        @endforeach
                        </div>
                        ...
                        <li data-target="#carousel-example-1" data-slide-to="{{$key}}" class="{{$key==0 ? 'active' : ''}}">
                                <img class="d-block w-100 img-fluid" src="{{asset('/storage/products/'.$images->image)}}" alt="" />
                            </li>
                            @endforeach
                        </ol>
                    </div>
                        ...
                        <div class="item">
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    <img src="{{asset('storage/products/'.$featuredProduct->image)}}" class="img-fluid" alt="Image">
                                    <div class="mask-icon">
                                        <ul>
