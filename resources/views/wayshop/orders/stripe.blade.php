            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <script src="https://js.stripe.com/v3/"></script>
                        ...
                        <form action="{{ url('pay-stripe')}}" method="post" id="payment-form"> {{csrf_field()}}
                        <div class="form-row">
...
var stripe = Stripe('pk_test_51HYPbbCsVtSxdbpXl6AFhtDvs9NlBiAoHATnsahYJOeroS1i1v0adtkqavK40tU5DGIANSi4z45elGhm1USEviSs00ELwmwof4');
