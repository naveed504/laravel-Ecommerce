                         ...
                         <tbody>
                            ...
                            <td>
                              ...
                              <div id="myElem" style="display:none;" class="alert alert-success">Status Enabled</div>
                               ...
                               <td>
                               <a href="{{url('edit-category/'.$category->id)}}" class="btn btn-add btn-sm"><i class="fa fa-pencil"></i></button>
                               <a href="{{url('delete-category/'.$category->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> </button>
                               </td>
                            </tr>
                             @endforeach
                         </tbody>
