       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('saveMultipleimages')}}" method="post"> {{csrf_field()}}
                  ...
                  <div class="table-responsive">
                     ...
                     <form enctype="multipart/form-data" action="{{url('/admin/edit-images/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                        ...
                        <tbody>
                           ...
                           <td>
                           <img src="{{url('storage/products/'.$productImage->image)}}" alt="" style="width:80px;">
                           </td>
                              <td class="center">
                                 <div class="btn-group">
